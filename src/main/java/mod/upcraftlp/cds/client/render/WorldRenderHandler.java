...
public class WorldRenderHandler {
    ...
    private static final Map<EntityPortal, Integer> textures = Maps.newConcurrentMap();
    ...
    public static boolean hasKey(EntityPortal entity) {
        synchronized(textures) {
            return textures.containsKey(entity);
        }
    }

    public static int getValue(EntityPortal entity) {
        synchronized(textures) {
            return textures.get(entity);
        }
    }
